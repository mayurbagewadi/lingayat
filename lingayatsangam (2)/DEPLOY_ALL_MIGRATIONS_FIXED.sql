-- ============================================================================
-- LINGAYAT MALI - CRITICAL DATABASE FIXES (CORRECTED ORDER)
-- Deploy Date: 2026-03-28
-- All 6 migrations combined for easy deployment
-- ============================================================================
...
alter table public.profiles
drop constraint if exists pdf_approval_status_check;
...
drop table if exists public.express_interests cascade;

create table public.express_interests (
...
drop table if exists public.daily_digest_sent cascade;

create table public.daily_digest_sent (
  id uuid primary key default gen_random_uuid(),
...
SELECT 'Migration 0: Role Column' as step;
SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'profiles' AND column_name = 'role';
...
-- ============================================================================
-- DEPLOYMENT COMPLETE
-- All 6 critical database fixes have been applied
-- ============================================================================
